export const MAIN_NAVIGATION = [
    { key: 'feed', url: '/', value: 'Feed', icon: 'home-alt' },
    { key: 'team', url: '#', value: 'Team members', icon: 'users-alt', desc: 'Coming soon' },
    { key: 'discover', url: '#', value: 'Discover', icon: 'star-1', desc: 'Coming soon' },

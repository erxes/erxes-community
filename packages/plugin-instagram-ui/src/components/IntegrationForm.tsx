...
class IntegrationForm extends React.Component<Props> {
  ...
  renderContent = (formProps: IFormProps) => {
    ...
    return (
      <>
        <p>Please enter your instagram name</p>
        ...
        <SelectChannels defaultValue={channelIds} isRequired={true} onChange={onChannelChange} />

        <ModalFooter>
          <Button btnStyle="simple" type="button" onClick={callback} icon="times-circle">
            Cancel
          </Button>
          {renderButton({

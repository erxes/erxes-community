...
import { IAssetDocument, assetSchema, assetCategorySchema } from './models/definitions/assets';
...
const gatherDescriptions = async (
  ...
  switch (type) {
    case MODULE_NAMES.ASSET:
      ...
      break;
    case MODULE_NAMES.ASSET_CATEGORY:
...
export default {
  getSchemaLabels: ({ data: { type } }) => ({
    ...
    data: getSchemaLabels(type, [
      ...
      { name: 'assetCategory', schemas: [assetCategorySchema] }
    ])
  })
};

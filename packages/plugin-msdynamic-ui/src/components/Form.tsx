...
class FormComponent extends React.Component<Props & ICommonFormProps, State> {
  constructor(props: Props) {
    ...
    const { msdynamic } = this.props;

    this.state = {
      expiryDate: msdynamic
        ? msdynamic.expiryDate
        : dayjs()
            .add(30, 'day')
            .toDate()
    };
  ...
  renderContent = (formProps: IFormProps) => {
    ...
    const object = msdynamic || ({} as IMsdynamic);
    return (
      <>
        <FormGroup>

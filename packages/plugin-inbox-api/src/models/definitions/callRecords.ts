...
const loadCallRecordClass = () => {
  class CallRecord {
    public static async createCallRecord(doc: ICallRecord): Promise<ICallRecordDocument> {
...
export const CallRecords: ICallRecordModel = model<ICallRecordDocument, ICallRecordModel>(
  'call_records',
  callRecordSchema,
);

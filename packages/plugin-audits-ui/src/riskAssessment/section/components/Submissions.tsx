...
class SubmissionsComponent extends React.Component<Props, State> {
  ...
  renderForm() {
    ...
    return fields.map(field => <GenerateField isEditing={true} defaultValue={submissions[field._id]} key={field._id} field={field} onValueChange={handleChange} isPreview={true} />);
  }

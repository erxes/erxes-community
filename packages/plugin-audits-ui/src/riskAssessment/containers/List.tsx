...
import { ICommonListProps, RiskAssessmentsCategoriesQueryResponse, RiskAssessmentsListQueryResponse } from '../common/types';
...
class ListContainer extends React.Component<FinalProps> {
  render() {
    ...
    const renderButton = ({ name, values, isSubmitted, callback, confirmationUpdate, object }: IButtonMutateProps) => {
      const afterMutate = () => {
        listQuery.refetch();
        if (callback) {
          callback();

...
class TableRow extends React.Component<IProps> {
  render() {
    ...
    return <ModalTrigger title="Edit Risk Assessment" enforceFocus={false} trigger={trigger} autoOpenKey="showListFormModal" content={contentForm} dialogClassName="transform" size="lg" />;
  }
}

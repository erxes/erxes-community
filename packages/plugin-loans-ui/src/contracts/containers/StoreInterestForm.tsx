...
import StoreInterestForm from '../components/list/StoreInterestForm';
...
class StoreInterestFormContainer extends React.Component<FinalProps> {
  render() {
    const renderButton = ({
      name,
      values,
    ...
    if (this.props.contractTypesMain?.contractTypesMain?.list?.length > 0) {
      ...
      return <StoreInterestForm {...updatedProps} />;
    } else return <div />;
  }
}
